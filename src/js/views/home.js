...
export const Home = props => {
	...
	useEffect(() => {
		fetch("https://8080-a97bff73-2556-4de8-ac45-640ee619643b.ws-us02.gitpod.io/wp-json/sample_api/v1/essentials")
			...
			.then(data => {
				...
				setTopessentials(data);
			});
	}, []);

	let top3 = topessentials.slice(0, 3);
	...
	return (
		<div>
			...
			<div className="container aboutUs">
				<div className="row ">
					<div className="col-4 justify-content-around  mt-5">
						...
						<p>
							<br />
							During this time of crisis where essentials are hard to come by
							{","} Spotted is here to help
							{"."} Lean on your community to find the items you
							{"'"}
							ve relentlessly been looking for. When did toilet paper become such a hot commodity
							{"?"}. We don
							{"'"}t knoq
							{","}
							but what we do know is that before you go and wait hours on a line for it
							{","} see if someone in your community has SPOTTED it for you
							{"!"}
						</p>
					</div>

					<div className="col-8 justify-content-around mt-5">
						<h2> THE SPOTTED TEAM </h2>
						<div className="card-group justify-content-around  text-center ladies">
							<Team
								member="Angel Key"
			...
			{/* <div className="text-center mt-5 py-3 coaBanner">
			...
			<div className="text-center mt-5 py-3 coaFooter text-white">
				<h4> JOIN THE MOVEMENT </h4>
				<h6> SPOT YOUR ESSENTIALS TODAY!</h6>
				<p />
